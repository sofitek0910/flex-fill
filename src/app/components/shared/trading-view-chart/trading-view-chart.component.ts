...
export class TradingViewChartComponent implements OnInit {
  ...
  private _libraryPath: ChartingLibraryWidgetOptions['library_path'] = '../../../../assets/charting-libs/charting_library/';
  ...
  loadTradingViewData(){
    this.Datafeed = {
      ...
      getBars: (symbolInfo, resolution, from, to, onHistoryCallback, onErrorCallback, firstDataRequest) => {
        ...
        this.tradeHistory.getBars(symbolInfo,resolution,from,to, firstDataRequest,2000).subscribe((data: any) => {
          console.log({data})
